 ...
 *  supplyfd: the descriptor where one pipes text to the child's
 *            stdin (or kNotInUse if child hasn't rewired its stdin)
 *  ingestfd: the descriptor where the text a child pushes to stdout
 *            shows up (or kNotInUse if child hasn't rewired its stdout)
 */
